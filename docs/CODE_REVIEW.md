...
| DIAG-001 | Medium | Host-swallowed render failures had no safe diagnostic path, while replaying a real payload could mutate live accounting. | 0.2.9 | Resolved by ADR 0029, isolated self-test, and allowlisted failure breadcrumb |
