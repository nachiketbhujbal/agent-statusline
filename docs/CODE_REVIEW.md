...
| PUB-003 | Medium | ADR 0018 included exact shared private-account allowance, timing, and consumption measurements that were unnecessary to preserve the lean-CI decision. | 0.2.12 | Current-tree text is generalized by public-safe ADR 0033; closure remains blocked on the reachable-history rewrite and audit in ADR 0034 |
...
| PUB-005 | High | Reachable branches and v0.2.1 through v0.2.11 tags retain the private ADR blob, while 12 release-spine merge commits retain a personal maintainer author identity. | 0.2.12 | Open and release-blocking: ADR 0034 defines the recoverable in-place rewrite; the deterministic reachable-history audit must pass on the rewritten candidate and remote refs |
